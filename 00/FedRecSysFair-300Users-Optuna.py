...
def objective(trial):
    ...
    normalized_variance_min = trial.suggest_float("normalized_variance_min", 0.1, 0.5)
    normalized_variance_max = trial.suggest_float("normalized_variance_max", 0.5, 0.9)
    p_diff_loss = trial.suggest_float("p_diff_loss", 0.1, 1.0)
    p_group_mean = trial.suggest_float("p_group_mean", 0.1, 1.0)
