...
def objective(trial):
    ...
    normalized_variance_min = trial.suggest_float("normalized_variance_min", 0.010, 0.50)
    normalized_variance_max = trial.suggest_float("normalized_variance_max", 0.051, 0.90)
    p_diff_loss = trial.suggest_float("p_diff_loss", 0.01, 1.0)
    p_group_mean = trial.suggest_float("p_group_mean", 0.01, 1.0)
...
# Melhores parâmetros encontrados: {'normalized_variance_min': 0.09151958698633235, 'normalized_variance_max': 0.47803360135516365, 'p_diff_loss': 0.3711686674406277, 'p_group_mean': 0.3131612639980199}