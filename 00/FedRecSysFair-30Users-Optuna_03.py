...
def objective(trial):
    ...
    normalized_variance_min = trial.suggest_float("normalized_variance_min", 0.001, 0.500)
    normalized_variance_max = trial.suggest_float("normalized_variance_max", 0.501, 1.000)
...
# Melhores parâmetros encontrados: {'normalized_variance_min': 0.24530661594047168, 'normalized_variance_max': 0.8242561810475086, 'p_diff_loss': 0.507523493734872, 'p_group_mean': 0.8976911146226088}