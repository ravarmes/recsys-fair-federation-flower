...
class FedCustom(fl.server.strategy.Strategy):
    def __init__(self, fraction_fit: float = 1.0, fraction_evaluate: float = 1.0, 
                 ...
                 factor_variance: float = 0.0, base_penalty_weight: float = 0.0, decay_rate: float = 0.0) -> None:
        super().__init__()
    ...
    def fairness_regularization(self, server_round, client_index, loss, global_mean_loss, group_mean_loss, global_groups_variance, factor_variance = 867.9540957096126, base_penalty_weight = 0.01, decay_rate = 0.001):
...
def objective(trial):
    ...
    base_penalty_weight = trial.suggest_float("base_penalty_weight", 0.01, 1)
