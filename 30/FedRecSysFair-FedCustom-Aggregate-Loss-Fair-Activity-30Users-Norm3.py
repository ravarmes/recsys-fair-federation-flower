...
def load_datasets(num_clients: int, filename: str, seed: int = 42):
    set_random_seed(seed)  # Define a semente logo aqui
...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def initialize_parameters(self, client_manager: ClientManager) -> Optional[Parameters]:
        set_random_seed(SEED)  # Defina a semente aqui para garantir que os pesos sejam sempre os mesmos
...
for nv in normalized_variance_tests:
    ...
    # Salvar o resultado de RgrpActivity do último round
