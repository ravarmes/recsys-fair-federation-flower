...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance, scale_group_mean = 0.016226499412696604, scale_groups_variance = 4.715585222554768):
        ...
        with open("FedFair-Loss-Activity-32-16-Fator-Soma-Round.log", "a") as log_file:
