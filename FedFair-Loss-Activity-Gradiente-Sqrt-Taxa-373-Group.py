...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        ...
        lr = self.adaptive_learning_rate(self.learning_rate, 0.01, server_round)
        
        fairness_penalty = group_mean_loss * (global_groups_variance ** 0.5) * adjustment_factor * lr
...
fl.simulation.start_simulation(
    ...
    strategy=FedCustom(initial_learning_rate=373.58023715763056),
