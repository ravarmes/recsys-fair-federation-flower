...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        fairness_penalty = group_mean_loss * (global_groups_variance ** 0.5) * self.learning_rate
        adjusted_loss = loss +  fairness_penalty

        with open("FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-43.log", "a") as log_file:
...
fl.simulation.start_simulation(
    ...
    strategy=FedCustom(initial_learning_rate=47.852416596627414),
