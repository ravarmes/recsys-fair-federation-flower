...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def __init__(self, fraction_fit: float = 1.0, fraction_evaluate: float = 1.0, 
                 ...
                 initial_learning_rate=0.2, initial_adjustment_factor_min=0.6912123892081427, initial_adjustment_factor_max=1.1071656821460363) -> None:
        super().__init__()
        ...
        self.adjustment_factor_min = initial_adjustment_factor_min
        self.adjustment_factor_max = initial_adjustment_factor_max
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        ...
        with open("FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group-Best.log", "a") as log_file:
...
# Melhores parâmetros encontrados: {'learning_rate': 0.2, 'adjustment_factor_min': 0.6912123892081427, 'adjustment_factor_max': 1.1071656821460363}
# Melhor valor da função objetivo: 0.00048138340710390007
