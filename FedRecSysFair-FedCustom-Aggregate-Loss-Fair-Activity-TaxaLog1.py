...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        adjusted_variance = math.exp(math.log(global_groups_variance + 1) * 5) 
        fairness_penalty = group_mean_loss * adjusted_variance


        with open("FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-TaxaLog1_debug.log", "a") as log_file:
