...
class FedCustom(Strategy):
    ...
    def fairness_regularization(self, loss, group_losses, lambda_fairness):
        group_variance = np.var(group_losses)
        return loss + lambda_fairness * group_variance
    ...
    def aggregate_fit(
        ...
        for client, fit_res in results:
            ...
            fairness_loss = self.fairness_regularization(local_loss, list(self.loss_avg_per_group.values()), lambda_fairness=-0.4)
