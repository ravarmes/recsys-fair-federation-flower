...
class FedCustom(Strategy):
    ...
    def fairness_regularization(self, loss, global_mean_loss, global_groups_variance, lambda_fairness):
        ...
        # Calcular a penalidade de justiça considerando a nova fórmula
        # Ao aumentar lambda_fairness, a penalidade relativa para cada perda é ponderada para ser mais influente
        fairness_penalty = diff_loss_global_mean * (1 / (1 / lambda_fairness + global_groups_variance))
        ...
        #     log_file.write(f"adjusted_loss: {adjusted_loss}\n")
        #     log_file.write("\n")  # Adicionar uma linha em branco para separar as entradas
    ...
    def aggregate_fit(
        ...
        for client_index, (client, fit_res) in enumerate(results):
            ...
            fairness_loss = self.fairness_regularization(local_loss, global_mean_loss, global_groups_variance, lambda_fairness=0.6)
