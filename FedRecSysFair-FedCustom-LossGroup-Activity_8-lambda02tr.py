...
class FedCustom(Strategy):
    ...
    def adaptive_learning_rate(self, initial_lr, decay_factor, round_num, global_groups_variance, min_lr=0.005, max_lr=0.02, scale_factor=10):
        if global_groups_variance == 1:
            return initial_lr
        else:
    ...
    def aggregate_fit(
        ...
        for client_index, (client, fit_res) in enumerate(results):
            ...
            fairness_loss = self.fairness_regularization(local_loss, global_mean_loss, lambda_fairness=0.2)
