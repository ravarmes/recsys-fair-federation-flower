...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, global_mean_loss, global_groups_variance):
        diff = loss - global_mean_loss
        
        fairness_penalty = (diff * (global_groups_variance ** 0.25)) * self.learning_rate
        adjusted_loss = loss + fairness_penalty

        with open("FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Global.log", "a") as log_file:
    ...
    def aggregate_fit(self, server_round: int, results: List[Tuple[ClientProxy, FitRes]], failures: List[Union[Tuple[ClientProxy, FitRes], BaseException]]) -> Tuple[Optional[Parameters], Dict[str, Scalar]]:
        ...
        global_mean_loss = total_loss / NUM_CLIENTS
        ...
        for client_index, (client, fit_res) in enumerate(results):
            ...
            fairness_loss = self.fairness_regularization(server_round, client_index, local_loss, global_mean_loss, global_groups_variance)
