...
class FedCustom(Strategy):
    ...
    def fairness_regularization(self, loss, global_mean_loss, global_groups_variance, lambda_fairness):
        ...
        # Calcular a penalidade de justiça considerando a nova fórmula ajustada
        fairness_penalty = (diff_loss_global_mean * (1 / (1 + global_groups_variance))) * lambda_fairness
