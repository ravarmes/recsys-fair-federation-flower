...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_mean_loss, global_groups_variance):
        ...
        normalized_variance_min = 0.24530661594047168
        normalized_variance_max = 0.8242561810475086
        p_diff_loss = 0.507523493734872
        p_group_mean = 0.8976911146226088
        ...
        with open("FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-Optuna_debug.log", "a") as log_file:
