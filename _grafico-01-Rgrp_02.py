...
# Subplot 1
ax1.plot(data_rgrp_activity_FedAvg["Round"], data_rgrp_activity_FedAvg["RgrpActivity"], label=r"FedAvg($n$)", linestyle='-')
ax1.plot(data_rgrp_activity_FedLoss["Round"], data_rgrp_activity_FedLoss["RgrpActivity"], label=r"FedAvg($\ell$)", linestyle='-')
ax1.plot(data_rgrp_activity_FairFed["Round"], data_rgrp_activity_FairFed["RgrpActivity"], label=r"FedFair($\ell$)", linestyle='-')
ax1.plot(data_rgrp_activity_FairFed["Round"], data_rgrp_activity_FairFed["RgrpActivity"], linestyle='-', color='green', linewidth=5, alpha=0.6)
...
# Subplot 2
ax2.plot(data_rgrp_age_FedAvg["Round"], data_rgrp_age_FedAvg["RgrpAge"], label=r"FedAvg($n$)", linestyle='-')
ax2.plot(data_rgrp_age_FedLoss["Round"], data_rgrp_age_FedLoss["RgrpAge"], label=r"FedAvg($\ell$)", linestyle='-')
ax2.plot(data_rgrp_age_FairFed["Round"], data_rgrp_age_FairFed["RgrpAge"], label=r"FedFair($\ell$)", linestyle='-')
...
# Subplot 3
ax3.plot(data_rgrp_gender_FedAvg["Round"], data_rgrp_gender_FedAvg["RgrpGender"], label=r"FedAvg($n$)", linestyle='-')
ax3.plot(data_rgrp_gender_FedLoss["Round"], data_rgrp_gender_FedLoss["RgrpGender"], label=r"FedAvg($\ell$)", linestyle='-')
ax3.plot(data_rgrp_gender_FairFed["Round"], data_rgrp_gender_FairFed["RgrpGender"], label=r"FedFair($\ell$)", linestyle='-')
