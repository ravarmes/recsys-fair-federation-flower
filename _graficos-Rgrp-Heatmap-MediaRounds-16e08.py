...
# Calcular as médias
rgrp_activity_FedAvg_n = np.mean(data_rgrp_activity_FedAvgExample_means)
rgrp_age_FedAvg_n = np.mean(data_rgrp_age_FedAvgExample_means)
rgrp_gender_FedAvg_n = np.mean(data_rgrp_gender_FedAvgExample_means)

rgrp_activity_FedAvg_l = np.mean(data_rgrp_activity_FedAvgLoss_means)
rgrp_age_FedAvg_l = np.mean(data_rgrp_age_FedAvgLoss_means)
rgrp_gender_FedAvg_l = np.mean(data_rgrp_gender_FedAvgLoss_means)

rgrp_activity_FairFed_l = np.mean(data_rgrp_activity_FedFairLoss_means)
rgrp_age_FairFed_l = np.mean(data_rgrp_age_FedFairLoss_means)
rgrp_gender_FairFed_l = np.mean(data_rgrp_gender_FedFairLoss_means)
...
plt.title("Redução Percentual de $R_{grp}$ Comparando com FedFair($\ell$) - Média dos Rounds")
plt.tight_layout()
plt.show()
