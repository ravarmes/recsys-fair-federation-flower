...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance, scale_group_mean, scale_groups_variance):
        ...
        with open("FedFair-Loss-Age-32-16-Fator-Soma-Optuna-300-Round.log", "a") as log_file:
...
# Best is trial 16 with value: 0.0051762713524995466. Melhores parâmetros encontrados: {'scale_group_mean': 0.7407425212367211, 'scale_groups_variance': 1.3967216175880492}
