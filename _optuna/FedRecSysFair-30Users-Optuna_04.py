...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, global_mean_loss, group_mean_loss, global_groups_variance, normalized_variance_min = 0.2, normalized_variance_max = 0.8, p_diff_loss = 1, p_group_mean = 1):
        ...
        fairness_penalty = (group_mean_loss * global_groups_variance) * p_group_mean
...
def objective(trial):
    ...
    p_group_mean = trial.suggest_float("p_group_mean", 0.01, 1000)
...
study.optimize(objective, n_trials=500)  # Define o número de iterações (trials)

# Imprimir os melhores parâmetros
best_params = study.best_params
print(f"Melhores parâmetros encontrados: {best_params}")

# Melhores parâmetros encontrados: {'p_group_mean': 713.9379222098974}