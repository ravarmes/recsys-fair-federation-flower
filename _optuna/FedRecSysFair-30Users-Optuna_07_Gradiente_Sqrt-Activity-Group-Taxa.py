...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        ...
        with open("FedRecSysFair-30Users-Optuna_07_Gradiente_Sqrt-Activity-Group-Taxa.log", "a") as log_file:
...
def objective(trial):
    ...
    strategy = FedCustom(
        ...
        initial_adjustment_factor_min = adjustment_factor_min,
        initial_adjustment_factor_max = adjustment_factor_max,
    )
