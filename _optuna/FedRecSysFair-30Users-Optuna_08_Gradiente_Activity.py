...
class FedCustom(fl.server.strategy.Strategy):
    ...
    def fairness_regularization(self, server_round, client_index, loss, group_mean_loss, global_groups_variance):
        fairness_penalty = (group_mean_loss * global_groups_variance) * (1 + self.learning_rate)
        adjusted_loss = loss + fairness_penalty

        with open("FedRecSysFair-30Users-Optuna_08_Gradiente_Activity.log", "a") as log_file:
