...
# # FairFed(l) AGE ------------------------------------------------------------------------------
# os.system("python FedFair-Loss-Age-16-8.py 2> FedFair-Loss-Age-16-8-01.txt")
# os.system("python FedFair-Loss-Age-16-8.py 2> FedFair-Loss-Age-16-8-02.txt")

# # FairFed(l) GENDER ---------------------------------------------------------------------------
# os.system("python FedFair-Loss-Gender-16-8.py.py 2> FedFair-Loss-Gender-16-8.py-01.txt")
# os.system("python FedFair-Loss-Gender-16-8.py.py 2> FedFair-Loss-Gender-16-8.py-02.txt")
