...
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Example.py 2> FedRecSysFair-FedCustom-AggregateInplace-Example-2.txt")
...
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Activity.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Activity-2.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Activity.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Activity-3.txt")

# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age-1.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age-2.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Age-3.txt")

# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender-1.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender-2.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-Fair-Gender-3.txt")

# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-3.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-4.txt")
# os.system("python FedRecSysFair-FedCustom-AggregateInplace-Loss.py 2> FedRecSysFair-FedCustom-AggregateInplace-Loss-5.txt")
...
os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-Taxa9-9.txt")
os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Age-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Age-Taxa9-9.txt")
os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Gender-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Gender-Taxa9-9.txt")

# os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Activity-Taxa9-8.txt")
# os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Age-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Age-Taxa9-8.txt")
# os.system("python FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Gender-Taxa9.py 2> FedRecSysFair-FedCustom-Aggregate-Loss-Fair-Gender-Taxa9-8.txt")