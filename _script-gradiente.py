...
os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-5.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-5-01.txt")
os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-5.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-5-02.txt")
