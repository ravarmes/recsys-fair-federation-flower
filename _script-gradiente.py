...
os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-6.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-6-01.txt")
os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-6.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-6-02.txt")
