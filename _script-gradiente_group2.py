...
os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2-06.txt")
# os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2-02.txt")
# os.system("python FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2.py 2> FedFair-Loss-Activity-Gradiente-Sqrt-Taxa-02-Group2-03.txt")
